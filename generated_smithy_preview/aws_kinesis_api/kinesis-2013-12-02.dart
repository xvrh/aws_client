...
enum MinimumThroughputBillingCommitmentInputStatus {
  ...
  const MinimumThroughputBillingCommitmentInputStatus(this.value);

  static MinimumThroughputBillingCommitmentInputStatus fromString(
          String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => throw Exception(
              '$value is not known in enum MinimumThroughputBillingCommitmentInputStatus'));
}
...
enum MinimumThroughputBillingCommitmentOutputStatus {
  enabled('ENABLED'),
  disabled('DISABLED'),
  enabledUntilEarliestAllowedEnd('ENABLED_UNTIL_EARLIEST_ALLOWED_END'),
  ;

  final String value;

  const MinimumThroughputBillingCommitmentOutputStatus(this.value);

  static MinimumThroughputBillingCommitmentOutputStatus fromString(
          String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => throw Exception(
              '$value is not known in enum MinimumThroughputBillingCommitmentOutputStatus'));
}
...
/// href="https://docs.aws.amazon.com/general/latest/gr/api-retries.html">Error
/// Retries and Exponential Backoff in Amazon Web Services</a> in the <i>Amazon
...
class SubscribeToShardEvent {
  ...
  factory SubscribeToShardEvent.fromJson(Map<String, dynamic> json) {
    return SubscribeToShardEvent(
      continuationSequenceNumber: json['ContinuationSequenceNumber'] as String,
      millisBehindLatest: json['MillisBehindLatest'] as int,
      records: (json['Records'] as List)
          .nonNulls
          .map((e) => Record.fromJson(e as Map<String, dynamic>))
