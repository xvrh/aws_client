...
class DeveloperUserAlreadyRegisteredException implements _s.AwsException {
  ...
  factory DeveloperUserAlreadyRegisteredException.fromJson(
...
/// not responding
class ExternalServiceException implements _s.AwsException {
  ...
  factory ExternalServiceException.fromJson(Map<String, dynamic> json) {
...
/// has no authenticated role configured, or STS returned an error response to
/// the request to assume the authenticated role from the identity pool. If you
/// provided no authentication information in the request, the identity pool has
/// no unauthenticated role configured, or STS returned an error response to the
/// request to assume the unauthenticated role from the identity pool.
///
/// Your role trust policy must grant <code>AssumeRoleWithWebIdentity</code>
/// permissions to <code>cognito-identity.amazonaws.com</code>.
class InvalidIdentityPoolConfigurationException implements _s.AwsException {
  /// The message returned for an
  /// <code>InvalidIdentityPoolConfigurationException</code>
  final String? message;
  ...
  factory InvalidIdentityPoolConfigurationException.fromJson(
      Map<String, dynamic> json) {
...
final _exceptionFns = <String, _s.AwsExceptionFn>{
  ...
  'DeveloperUserAlreadyRegisteredException': (type, message) =>
      DeveloperUserAlreadyRegisteredException(message: message),
  'ExternalServiceException': (type, message) =>
      ExternalServiceException(message: message),
  ...
  'InvalidIdentityPoolConfigurationException': (type, message) =>
      InvalidIdentityPoolConfigurationException(message: message),
