...
class BatchEntryIdsNotDistinct implements _s.AwsException {
  ...
  factory BatchEntryIdsNotDistinct.fromJson(Map<String, dynamic> json) {
...
class BatchRequestTooLong implements _s.AwsException {
  final String? message;
  ...
  factory BatchRequestTooLong.fromJson(Map<String, dynamic> json) {
...
class EmptyBatchRequest implements _s.AwsException {
  final String? message;
  ...
  factory EmptyBatchRequest.fromJson(Map<String, dynamic> json) {
...
class InvalidAddress implements _s.AwsException {
  final String? message;
  ...
  factory InvalidAddress.fromJson(Map<String, dynamic> json) {
...
class InvalidAttributeName implements _s.AwsException {
  final String? message;
  ...
  factory InvalidAttributeName.fromJson(Map<String, dynamic> json) {
...
class InvalidAttributeValue implements _s.AwsException {
  final String? message;
  ...
  factory InvalidAttributeValue.fromJson(Map<String, dynamic> json) {
...
/// specification.
class InvalidBatchEntryId implements _s.AwsException {
  final String? message;
  ...
  factory InvalidBatchEntryId.fromJson(Map<String, dynamic> json) {
...
class InvalidIdFormat implements _s.AwsException {
  InvalidIdFormat();

  factory InvalidIdFormat.fromJson(Map<String, dynamic> _) {
    return InvalidIdFormat();
  }
}

/// The message contains characters outside the allowed set.
class InvalidMessageContents implements _s.AwsException {
  final String? message;
  ...
  factory InvalidMessageContents.fromJson(Map<String, dynamic> json) {
...
class InvalidSecurity implements _s.AwsException {
  final String? message;
  ...
  factory InvalidSecurity.fromJson(Map<String, dynamic> json) {
...
class KmsAccessDenied implements _s.AwsException {
  final String? message;
  ...
  factory KmsAccessDenied.fromJson(Map<String, dynamic> json) {
...
class KmsDisabled implements _s.AwsException {
  final String? message;
  ...
  factory KmsDisabled.fromJson(Map<String, dynamic> json) {
    return KmsDisabled(
      message: json['message'] as String?,
    );
  }
...
/// </li>
/// </ul>
class KmsInvalidKeyUsage implements _s.AwsException {
  final String? message;
  ...
  factory KmsInvalidKeyUsage.fromJson(Map<String, dynamic> json) {
...
class KmsInvalidState implements _s.AwsException {
  final String? message;
  ...
  factory KmsInvalidState.fromJson(Map<String, dynamic> json) {
...
/// be found.
class KmsNotFound implements _s.AwsException {
  final String? message;
  ...
  factory KmsNotFound.fromJson(Map<String, dynamic> json) {
    return KmsNotFound(
      message: json['message'] as String?,
    );
  }
...
class KmsThrottled implements _s.AwsException {
  final String? message;
  ...
  factory KmsThrottled.fromJson(Map<String, dynamic> json) {
    return KmsThrottled(
      message: json['message'] as String?,
    );
  }
...
class MessageNotInflight implements _s.AwsException {
  MessageNotInflight();

  factory MessageNotInflight.fromJson(Map<String, dynamic> _) {
...
/// <code>ReceiveMessage</code> returns this error if the maximum number of in
/// flight messages is reached and <code>AddPermission</code> returns this error
/// if the maximum number of permissions for the queue is reached.
class OverLimit implements _s.AwsException {
  final String? message;
  ...
  factory OverLimit.fromJson(Map<String, dynamic> json) {
    return OverLimit(
      message: json['message'] as String?,
    );
  }
...
class PurgeQueueInProgress implements _s.AwsException {
  final String? message;
  ...
  factory PurgeQueueInProgress.fromJson(Map<String, dynamic> json) {
...
class QueueDeletedRecently implements _s.AwsException {
  final String? message;
  ...
  factory QueueDeletedRecently.fromJson(Map<String, dynamic> json) {
...
/// Ensure that the <code>QueueUrl</code> is correct and that the queue has not
/// been deleted.
class QueueDoesNotExist implements _s.AwsException {
  final String? message;
  ...
  factory QueueDoesNotExist.fromJson(Map<String, dynamic> json) {
...
/// existing queue.
class QueueNameExists implements _s.AwsException {
  final String? message;
  ...
  factory QueueNameExists.fromJson(Map<String, dynamic> json) {
...
class ReceiptHandleIsInvalid implements _s.AwsException {
  final String? message;
  ...
  factory ReceiptHandleIsInvalid.fromJson(Map<String, dynamic> json) {
...
/// messages. For more information, see <a
/// href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-quotas.html#quotas-requests">Amazon
/// SQS quotas</a> in the <i>Amazon SQS Developer Guide</i>.
/// </li>
/// </ul>
class RequestThrottled implements _s.AwsException {
  final String? message;
  ...
  factory RequestThrottled.fromJson(Map<String, dynamic> json) {
...
/// the maximum number of entries you can include in a single <a
/// href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_SendMessageBatch.html">SendMessageBatch</a>,
/// <a
/// href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_DeleteMessageBatch.html">DeleteMessageBatch</a>,
/// or <a
/// href="https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_ChangeMessageVisibilityBatch.html">ChangeMessageVisibilityBatch</a>
/// request is 10.
class TooManyEntriesInBatchRequest implements _s.AwsException {
  final String? message;
  ...
  factory TooManyEntriesInBatchRequest.fromJson(Map<String, dynamic> json) {
...
class UnsupportedOperation implements _s.AwsException {
  final String? message;
  ...
  factory UnsupportedOperation.fromJson(Map<String, dynamic> json) {
...
final _exceptionFns = <String, _s.AwsExceptionFn>{
  'BatchEntryIdsNotDistinct': (type, message) =>
      BatchEntryIdsNotDistinct(message: message),
  'BatchRequestTooLong': (type, message) =>
      BatchRequestTooLong(message: message),
  'EmptyBatchRequest': (type, message) => EmptyBatchRequest(message: message),
  'InvalidAddress': (type, message) => InvalidAddress(message: message),
  'InvalidAttributeName': (type, message) =>
      InvalidAttributeName(message: message),
  'InvalidAttributeValue': (type, message) =>
      InvalidAttributeValue(message: message),
  'InvalidBatchEntryId': (type, message) =>
      InvalidBatchEntryId(message: message),
  'InvalidIdFormat': (type, message) => InvalidIdFormat(),
  'InvalidMessageContents': (type, message) =>
      InvalidMessageContents(message: message),
  'InvalidSecurity': (type, message) => InvalidSecurity(message: message),
  'KmsAccessDenied': (type, message) => KmsAccessDenied(message: message),
  'KmsDisabled': (type, message) => KmsDisabled(message: message),
  'KmsInvalidKeyUsage': (type, message) => KmsInvalidKeyUsage(message: message),
  'KmsInvalidState': (type, message) => KmsInvalidState(message: message),
  'KmsNotFound': (type, message) => KmsNotFound(message: message),
  'KmsOptInRequired': (type, message) => KmsOptInRequired(message: message),
  'KmsThrottled': (type, message) => KmsThrottled(message: message),
  'MessageNotInflight': (type, message) => MessageNotInflight(),
  'OverLimit': (type, message) => OverLimit(message: message),
  'PurgeQueueInProgress': (type, message) =>
      PurgeQueueInProgress(message: message),
  'QueueDeletedRecently': (type, message) =>
      QueueDeletedRecently(message: message),
  'QueueDoesNotExist': (type, message) => QueueDoesNotExist(message: message),
  'QueueNameExists': (type, message) => QueueNameExists(message: message),
  'ReceiptHandleIsInvalid': (type, message) =>
      ReceiptHandleIsInvalid(message: message),
  'RequestThrottled': (type, message) => RequestThrottled(message: message),
  'ResourceNotFoundException': (type, message) =>
      ResourceNotFoundException(message: message),
  'TooManyEntriesInBatchRequest': (type, message) =>
      TooManyEntriesInBatchRequest(message: message),
  'UnsupportedOperation': (type, message) =>
      UnsupportedOperation(message: message),
};
