...
class ExpiredTokenException implements _s.AwsException {
  final String? message;

  ExpiredTokenException({
    this.message,
  });
  factory ExpiredTokenException.fromXml(_s.XmlElement elem) {
...
class ExpiredTradeInTokenException implements _s.AwsException {
  final String? message;

  ExpiredTradeInTokenException({
    this.message,
  });
  factory ExpiredTradeInTokenException.fromXml(_s.XmlElement elem) {
...
class IDPCommunicationErrorException implements _s.AwsException {
  final String? message;

  IDPCommunicationErrorException({
    this.message,
  });
  factory IDPCommunicationErrorException.fromXml(_s.XmlElement elem) {
...
/// explicitly revoked.
class IDPRejectedClaimException implements _s.AwsException {
  final String? message;

  IDPRejectedClaimException({
    this.message,
  });
  factory IDPRejectedClaimException.fromXml(_s.XmlElement elem) {
...
/// token contains invalid characters, such as line breaks, or if the message
/// has expired.
class InvalidAuthorizationMessageException implements _s.AwsException {
  final String? message;

  InvalidAuthorizationMessageException({
    this.message,
  });
  factory InvalidAuthorizationMessageException.fromXml(_s.XmlElement elem) {
...
/// the request.
class InvalidIdentityTokenException implements _s.AwsException {
  final String? message;

  InvalidIdentityTokenException({
    this.message,
  });
  factory InvalidIdentityTokenException.fromXml(_s.XmlElement elem) {
...
/// The requested token payload size exceeds the maximum allowed size. Reduce
/// the number of request tags included in the <code>GetWebIdentityToken</code>
/// API call to reduce the token payload size.
class JWTPayloadSizeExceededException implements _s.AwsException {
  final String? message;

  JWTPayloadSizeExceededException({
    this.message,
  });
  factory JWTPayloadSizeExceededException.fromXml(_s.XmlElement elem) {
...
class MalformedPolicyDocumentException implements _s.AwsException {
  ...
  factory MalformedPolicyDocumentException.fromXml(_s.XmlElement elem) {
...
/// account. To use this feature, you must first enable it through the Amazon
/// Web Services Management Console or API.
class OutboundWebIdentityFederationDisabledException
  ...
  factory OutboundWebIdentityFederationDisabledException.fromXml(
      _s.XmlElement elem) {
...
/// session tags into a packed binary format that has a separate limit. The
/// error message indicates by percentage how close the policies and tags are to
/// the upper size limit. For more information, see <a
/// href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html">Passing
/// Session Tags in STS</a> in the <i>IAM User Guide</i>.
///
/// You could receive this error even though you meet other defined session
/// policy and session tag limits. For more information, see <a
...
class PackedPolicyTooLargeException implements _s.AwsException {
  final String? message;

  PackedPolicyTooLargeException({
    this.message,
  });
  factory PackedPolicyTooLargeException.fromXml(_s.XmlElement elem) {
...
/// console to activate STS in that region. For more information, see <a
/// href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html#sts-regions-activate-deactivate">Activating
/// and Deactivating STS in an Amazon Web Services Region</a> in the <i>IAM User
/// Guide</i>.
class RegionDisabledException implements _s.AwsException {
  final String? message;

  RegionDisabledException({
    this.message,
  });
  factory RegionDisabledException.fromXml(_s.XmlElement elem) {
...
class SessionDurationEscalationException implements _s.AwsException {
  final String? message;

  SessionDurationEscalationException({
    this.message,
  });
  factory SessionDurationEscalationException.fromXml(_s.XmlElement elem) {
...
final _exceptionFns = <String, _s.AwsExceptionFn>{
  'ExpiredTokenException': (type, message) =>
      ExpiredTokenException(message: message),
  'ExpiredTradeInTokenException': (type, message) =>
      ExpiredTradeInTokenException(message: message),
  'IDPCommunicationErrorException': (type, message) =>
      IDPCommunicationErrorException(message: message),
  'IDPRejectedClaimException': (type, message) =>
      IDPRejectedClaimException(message: message),
  'InvalidAuthorizationMessageException': (type, message) =>
      InvalidAuthorizationMessageException(message: message),
  'InvalidIdentityTokenException': (type, message) =>
      InvalidIdentityTokenException(message: message),
  'JWTPayloadSizeExceededException': (type, message) =>
      JWTPayloadSizeExceededException(message: message),
  ...
  'OutboundWebIdentityFederationDisabledException': (type, message) =>
      OutboundWebIdentityFederationDisabledException(message: message),
  'PackedPolicyTooLargeException': (type, message) =>
      PackedPolicyTooLargeException(message: message),
  'RegionDisabledException': (type, message) =>
      RegionDisabledException(message: message),
  'SessionDurationEscalationException': (type, message) =>
      SessionDurationEscalationException(message: message),
};
