...
enum AcceleratedRecoveryStatus {
  enabling('ENABLING'),
  enableFailed('ENABLE_FAILED'),
  enablingHostedZoneLocked('ENABLING_HOSTED_ZONE_LOCKED'),
  enabled('ENABLED'),
  disabling('DISABLING'),
  disableFailed('DISABLE_FAILED'),
  disabled('DISABLED'),
  disablingHostedZoneLocked('DISABLING_HOSTED_ZONE_LOCKED'),
  ;

  final String value;

  const AcceleratedRecoveryStatus(this.value);

  static AcceleratedRecoveryStatus fromString(String value) =>
      values.firstWhere((e) => e.value == value,
          orElse: () => throw Exception(
              '$value is not known in enum AcceleratedRecoveryStatus'));
}
...
class CidrBlockInUseException implements _s.AwsException {
  final String? message;

  CidrBlockInUseException({
    this.message,
  });
  factory CidrBlockInUseException.fromXml(_s.XmlElement elem) {
...
class CidrCollectionAlreadyExistsException implements _s.AwsException {
  final String? message;

  CidrCollectionAlreadyExistsException({
    this.message,
  });
  factory CidrCollectionAlreadyExistsException.fromXml(_s.XmlElement elem) {
...
class CidrCollectionInUseException implements _s.AwsException {
  final String? message;

  CidrCollectionInUseException({
    this.message,
  });
  factory CidrCollectionInUseException.fromXml(_s.XmlElement elem) {
...
/// <code>ListCidrCollections</code> operation.
class CidrCollectionVersionMismatchException implements _s.AwsException {
  final String? message;

  CidrCollectionVersionMismatchException({
    this.message,
  });
  factory CidrCollectionVersionMismatchException.fromXml(_s.XmlElement elem) {
...
enum CloudWatchRegion {
  ...
  mxCentral_1('mx-central-1'),
  usIsofSouth_1('us-isof-south-1'),
  usIsofEast_1('us-isof-east-1'),
  apSoutheast_7('ap-southeast-7'),
  apEast_2('ap-east-2'),
  euIsoeWest_1('eu-isoe-west-1'),
  apSoutheast_6('ap-southeast-6'),
  usIsobWest_1('us-isob-west-1'),
  euscDeEast_1('eusc-de-east-1'),
  ;
...
class ConcurrentModification implements _s.AwsException {
  ///
  final String? message;
  ...
  factory ConcurrentModification.fromXml(_s.XmlElement elem) {
...
/// <ul>
/// <li>
/// <b>Create a public hosted zone:</b> Two hosted zones that have the same name
/// or that have a parent/child relationship (example.com and test.example.com)
/// can't have any common name servers. You tried to create a hosted zone that
/// has the same name as an existing hosted zone or that's the parent or child
/// of an existing hosted zone, and you specified a delegation set that shares
/// one or more name servers with the existing hosted zone. For more
/// information, see <a
/// href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateReusableDelegationSet.html">CreateReusableDelegationSet</a>.
/// </li>
/// <li>
...
/// </li>
/// <li>
/// <b>Associate VPCs with a private hosted zone:</b> The VPC that you specified
/// is already associated with another hosted zone that has the same name.
/// </li>
/// </ul>
class ConflictingDomainExists implements _s.AwsException {
  final String? message;

  ConflictingDomainExists({
    this.message,
  });
  factory ConflictingDomainExists.fromXml(_s.XmlElement elem) {
...
class ConflictingTypes implements _s.AwsException {
  ///
  final String? message;
  ...
  factory ConflictingTypes.fromXml(_s.XmlElement elem) {
...
class DNSSECNotFound implements _s.AwsException {
  final String? message;

  DNSSECNotFound({
    this.message,
  });
  factory DNSSECNotFound.fromXml(_s.XmlElement elem) {
...
class DelegationSetAlreadyCreated implements _s.AwsException {
  ///
  final String? message;
  ...
  factory DelegationSetAlreadyCreated.fromXml(_s.XmlElement elem) {
...
class DelegationSetAlreadyReusable implements _s.AwsException {
  ///
  final String? message;
  ...
  factory DelegationSetAlreadyReusable.fromXml(_s.XmlElement elem) {
...
class DelegationSetInUse implements _s.AwsException {
  ///
  final String? message;
  ...
  factory DelegationSetInUse.fromXml(_s.XmlElement elem) {
...
class DelegationSetNotAvailable implements _s.AwsException {
  ///
  final String? message;
  ...
  factory DelegationSetNotAvailable.fromXml(_s.XmlElement elem) {
...
class DelegationSetNotReusable implements _s.AwsException {
  ///
  final String? message;
  ...
  factory DelegationSetNotReusable.fromXml(_s.XmlElement elem) {
...
/// <ul>
/// <li>
/// The same value for <code>CallerReference</code> as an existing health check,
/// and one or more values that differ from the existing health check that has
/// the same caller reference.
/// </li>
/// <li>
/// The same value for <code>CallerReference</code> as a health check that you
/// created and later deleted, regardless of the other settings in the request.
/// </li>
/// </ul>
class HealthCheckAlreadyExists implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HealthCheckAlreadyExists.fromXml(_s.XmlElement elem) {
...
class HealthCheckInUse implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HealthCheckInUse.fromXml(_s.XmlElement elem) {
...
/// The value of <code>HealthCheckVersion</code> in the request doesn't match
/// the value of <code>HealthCheckVersion</code> in the health check.
class HealthCheckVersionMismatch implements _s.AwsException {
  final String? message;

  HealthCheckVersionMismatch({
    this.message,
  });
  factory HealthCheckVersionMismatch.fromXml(_s.XmlElement elem) {
...
class HostedZoneAlreadyExists implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HostedZoneAlreadyExists.fromXml(_s.XmlElement elem) {
...
class HostedZoneNotEmpty implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HostedZoneNotEmpty.fromXml(_s.XmlElement elem) {
...
class HostedZoneNotFound implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HostedZoneNotFound.fromXml(_s.XmlElement elem) {
...
/// zone.
class HostedZoneNotPrivate implements _s.AwsException {
  ///
  final String? message;
  ...
  factory HostedZoneNotPrivate.fromXml(_s.XmlElement elem) {
...
class HostedZonePartiallyDelegated implements _s.AwsException {
  final String? message;

  HostedZonePartiallyDelegated({
    this.message,
  });
  factory HostedZonePartiallyDelegated.fromXml(_s.XmlElement elem) {
...
/// endpoint.
class IncompatibleVersion implements _s.AwsException {
  final String? message;

  IncompatibleVersion({
    this.message,
  });
  factory IncompatibleVersion.fromXml(_s.XmlElement elem) {
...
/// for <code>Resource</code>.
/// </li>
/// <li>
/// The resource policy that includes the log group ARN in the value for
/// <code>Resource</code> doesn't have the necessary permissions.
/// </li>
/// <li>
...
/// </li>
/// <li>
/// The Key management service (KMS) key you specified is marked as disabled for
/// the log group associated with query log. Update or provide a resource policy
/// to grant permissions for the KMS key.
/// </li>
/// </ul>
class InsufficientCloudWatchLogsResourcePolicy implements _s.AwsException {
  final String? message;

  InsufficientCloudWatchLogsResourcePolicy({
    this.message,
  });
  factory InsufficientCloudWatchLogsResourcePolicy.fromXml(_s.XmlElement elem) {
...
class InvalidChangeBatch implements _s.AwsException {
  final String? message;
  ...
  factory InvalidChangeBatch.fromXml(_s.XmlElement elem) {
    return InvalidChangeBatch(
      message: _s.extractXmlStringValue(elem, 'message'),
      messages: _s
          .extractXmlChild(elem, 'messages')
          ?.let((elem) => _s.extractXmlStringListValues(elem, 'Message')),
    );
  }
}

/// The specified domain name is not valid.
class InvalidDomainName implements _s.AwsException {
  ///
  final String? message;
  ...
  factory InvalidDomainName.fromXml(_s.XmlElement elem) {
...
class InvalidInput implements _s.AwsException {
  ...
  factory InvalidInput.fromXml(_s.XmlElement elem) {
    return InvalidInput(
      message: _s.extractXmlStringValue(elem, 'message'),
    );
  }
...
/// DNSSEC signing.
class InvalidKMSArn implements _s.AwsException {
  final String? message;

  InvalidKMSArn({
    this.message,
  });
  factory InvalidKMSArn.fromXml(_s.XmlElement elem) {
...
class InvalidKeySigningKeyName implements _s.AwsException {
  final String? message;

  InvalidKeySigningKeyName({
    this.message,
  });
  factory InvalidKeySigningKeyName.fromXml(_s.XmlElement elem) {
...
class InvalidKeySigningKeyStatus implements _s.AwsException {
  final String? message;

  InvalidKeySigningKeyStatus({
    this.message,
  });
  factory InvalidKeySigningKeyStatus.fromXml(_s.XmlElement elem) {
...
/// is invalid.
class InvalidPaginationToken implements _s.AwsException {
  final String? message;

  InvalidPaginationToken({
    this.message,
  });
  factory InvalidPaginationToken.fromXml(_s.XmlElement elem) {
...
/// change the status to enable <code>DNSSEC</code> or disable
/// <code>DNSSEC</code>.
class InvalidSigningStatus implements _s.AwsException {
  final String? message;

  InvalidSigningStatus({
    this.message,
  });
  factory InvalidSigningStatus.fromXml(_s.XmlElement elem) {
...
/// <code>Document</code> element is not valid.
class InvalidTrafficPolicyDocument implements _s.AwsException {
  ///
  final String? message;
  ...
  factory InvalidTrafficPolicyDocument.fromXml(_s.XmlElement elem) {
...
class InvalidVPCId implements _s.AwsException {
  ///
  final String? message;
  ...
  factory InvalidVPCId.fromXml(_s.XmlElement elem) {
    return InvalidVPCId(
      message: _s.extractXmlStringValue(elem, 'message'),
    );
  }
...
class KeySigningKeyAlreadyExists implements _s.AwsException {
  final String? message;

  KeySigningKeyAlreadyExists({
    this.message,
  });
  factory KeySigningKeyAlreadyExists.fromXml(_s.XmlElement elem) {
...
class KeySigningKeyInParentDSRecord implements _s.AwsException {
  final String? message;

  KeySigningKeyInParentDSRecord({
    this.message,
  });
  factory KeySigningKeyInParentDSRecord.fromXml(_s.XmlElement elem) {
...
/// it's the only KSK for a currently-enabled DNSSEC. Disable DNSSEC signing, or
/// add or enable another KSK.
class KeySigningKeyInUse implements _s.AwsException {
  final String? message;

  KeySigningKeyInUse({
    this.message,
  });
  factory KeySigningKeyInUse.fromXml(_s.XmlElement elem) {
...
class KeySigningKeyWithActiveStatusNotFound implements _s.AwsException {
  final String? message;

  KeySigningKeyWithActiveStatusNotFound({
    this.message,
  });
  factory KeySigningKeyWithActiveStatusNotFound.fromXml(_s.XmlElement elem) {
...
/// the last VPC that is associated with the hosted zone. Amazon Route 53
/// doesn't support disassociating the last VPC from a hosted zone.
class LastVPCAssociation implements _s.AwsException {
  ///
  final String? message;
  ...
  factory LastVPCAssociation.fromXml(_s.XmlElement elem) {
...
/// the limit on the resource you are trying to create. To request a higher
/// limit, <a href="http://aws.amazon.com/route53-request">create a case</a>
/// with the Amazon Web Services Support Center.
class LimitsExceeded implements _s.AwsException {
  ///
  final String? message;
  ...
  factory LimitsExceeded.fromXml(_s.XmlElement elem) {
...
class NoSuchChange implements _s.AwsException {
  final String? message;

  NoSuchChange({
    this.message,
  });
  factory NoSuchChange.fromXml(_s.XmlElement elem) {
    return NoSuchChange(
      message: _s.extractXmlStringValue(elem, 'message'),
    );
  }
...
class NoSuchCidrCollectionException implements _s.AwsException {
  final String? message;

  NoSuchCidrCollectionException({
    this.message,
  });
  factory NoSuchCidrCollectionException.fromXml(_s.XmlElement elem) {
...
class NoSuchCidrLocationException implements _s.AwsException {
  final String? message;

  NoSuchCidrLocationException({
    this.message,
  });
  factory NoSuchCidrLocationException.fromXml(_s.XmlElement elem) {
...
class NoSuchCloudWatchLogsLogGroup implements _s.AwsException {
  final String? message;

  NoSuchCloudWatchLogsLogGroup({
    this.message,
  });
  factory NoSuchCloudWatchLogsLogGroup.fromXml(_s.XmlElement elem) {
...
/// A reusable delegation set with the specified ID does not exist.
class NoSuchDelegationSet implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchDelegationSet.fromXml(_s.XmlElement elem) {
...
/// href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_GeoLocation.html">GeoLocation</a>
/// data type.
class NoSuchGeoLocation implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchGeoLocation.fromXml(_s.XmlElement elem) {
...
class NoSuchHealthCheck implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchHealthCheck.fromXml(_s.XmlElement elem) {
...
class NoSuchHostedZone implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchHostedZone.fromXml(_s.XmlElement elem) {
...
class NoSuchKeySigningKey implements _s.AwsException {
  final String? message;

  NoSuchKeySigningKey({
    this.message,
  });
  factory NoSuchKeySigningKey.fromXml(_s.XmlElement elem) {
...
class NoSuchQueryLoggingConfig implements _s.AwsException {
  final String? message;

  NoSuchQueryLoggingConfig({
    this.message,
  });
  factory NoSuchQueryLoggingConfig.fromXml(_s.XmlElement elem) {
...
class NoSuchTrafficPolicy implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchTrafficPolicy.fromXml(_s.XmlElement elem) {
...
class NoSuchTrafficPolicyInstance implements _s.AwsException {
  ///
  final String? message;
  ...
  factory NoSuchTrafficPolicyInstance.fromXml(_s.XmlElement elem) {
...
class NotAuthorizedException implements _s.AwsException {
  ...
  factory NotAuthorizedException.fromXml(_s.XmlElement elem) {
...
class PriorRequestNotComplete implements _s.AwsException {
  final String? message;

  PriorRequestNotComplete({
    this.message,
  });
  factory PriorRequestNotComplete.fromXml(_s.XmlElement elem) {
...
class PublicZoneVPCAssociation implements _s.AwsException {
  ///
  final String? message;
  ...
  factory PublicZoneVPCAssociation.fromXml(_s.XmlElement elem) {
...
class QueryLoggingConfigAlreadyExists implements _s.AwsException {
  final String? message;

  QueryLoggingConfigAlreadyExists({
    this.message,
  });
  factory QueryLoggingConfigAlreadyExists.fromXml(_s.XmlElement elem) {
...
class ThrottlingException implements _s.AwsException {
  ...
  factory ThrottlingException.fromXml(_s.XmlElement elem) {
...
/// href="http://aws.amazon.com/route53-request">create a case</a> with the
/// Amazon Web Services Support Center.
///
/// You have reached the maximum number of active health checks for an Amazon
/// Web Services account. To request a higher limit, <a
/// href="http://aws.amazon.com/route53-request">create a case</a> with the
/// Amazon Web Services Support Center.
class TooManyHealthChecks implements _s.AwsException {
  final String? message;

  TooManyHealthChecks({
    this.message,
  });
  factory TooManyHealthChecks.fromXml(_s.XmlElement elem) {
...
/// the limit on the number of hosted zones that can be associated with a
/// reusable delegation set.
///
/// For information about default limits, see <a
/// href="https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html">Limits</a>
...
/// reusable delegation set, see <a
/// href="https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetReusableDelegationSetLimit.html">GetReusableDelegationSetLimit</a>.
///
/// To request a higher limit, <a
/// href="http://aws.amazon.com/route53-request">create a case</a> with the
/// Amazon Web Services Support Center.
class TooManyHostedZones implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TooManyHostedZones.fromXml(_s.XmlElement elem) {
...
class TooManyKeySigningKeys implements _s.AwsException {
  final String? message;

  TooManyKeySigningKeys({
    this.message,
  });
  factory TooManyKeySigningKeys.fromXml(_s.XmlElement elem) {
...
/// href="http://aws.amazon.com/route53-request">create a case</a> with the
/// Amazon Web Services Support Center.
class TooManyTrafficPolicies implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TooManyTrafficPolicies.fromXml(_s.XmlElement elem) {
...
/// href="http://aws.amazon.com/route53-request">create a case</a> with the
/// Amazon Web Services Support Center.
class TooManyTrafficPolicyInstances implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TooManyTrafficPolicyInstances.fromXml(_s.XmlElement elem) {
...
/// This traffic policy version can't be created because you've reached the
/// limit of 1000 on the number of versions that you can create for the current
/// traffic policy.
///
...
class TooManyTrafficPolicyVersionsForCurrentPolicy implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TooManyTrafficPolicyVersionsForCurrentPolicy.fromXml(
      _s.XmlElement elem) {
...
/// the hosted zone, submit a <code>DeleteVPCAssociationAuthorization</code>
...
/// request.
class TooManyVPCAssociationAuthorizations implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TooManyVPCAssociationAuthorizations.fromXml(_s.XmlElement elem) {
...
/// exists.
class TrafficPolicyAlreadyExists implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TrafficPolicyAlreadyExists.fromXml(_s.XmlElement elem) {
...
/// traffic policy.
class TrafficPolicyInUse implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TrafficPolicyInUse.fromXml(_s.XmlElement elem) {
...
class TrafficPolicyInstanceAlreadyExists implements _s.AwsException {
  ///
  final String? message;
  ...
  factory TrafficPolicyInstanceAlreadyExists.fromXml(_s.XmlElement elem) {
...
/// hosted zone.
class VPCAssociationAuthorizationNotFound implements _s.AwsException {
  ///
  final String? message;
  ...
  factory VPCAssociationAuthorizationNotFound.fromXml(_s.XmlElement elem) {
...
class VPCAssociationNotFound implements _s.AwsException {
  ...
  factory VPCAssociationNotFound.fromXml(_s.XmlElement elem) {
...
final _exceptionFns = <String, _s.AwsExceptionFn>{
  'CidrBlockInUseException': (type, message) =>
      CidrBlockInUseException(message: message),
  'CidrCollectionAlreadyExistsException': (type, message) =>
      CidrCollectionAlreadyExistsException(message: message),
  'CidrCollectionInUseException': (type, message) =>
      CidrCollectionInUseException(message: message),
  'CidrCollectionVersionMismatchException': (type, message) =>
      CidrCollectionVersionMismatchException(message: message),
  'ConcurrentModification': (type, message) =>
      ConcurrentModification(message: message),
  'ConflictingDomainExists': (type, message) =>
      ConflictingDomainExists(message: message),
  'ConflictingTypes': (type, message) => ConflictingTypes(message: message),
  'DNSSECNotFound': (type, message) => DNSSECNotFound(message: message),
  'DelegationSetAlreadyCreated': (type, message) =>
      DelegationSetAlreadyCreated(message: message),
  'DelegationSetAlreadyReusable': (type, message) =>
      DelegationSetAlreadyReusable(message: message),
  'DelegationSetInUse': (type, message) => DelegationSetInUse(message: message),
  'DelegationSetNotAvailable': (type, message) =>
      DelegationSetNotAvailable(message: message),
  'DelegationSetNotReusable': (type, message) =>
      DelegationSetNotReusable(message: message),
  'HealthCheckAlreadyExists': (type, message) =>
      HealthCheckAlreadyExists(message: message),
  'HealthCheckInUse': (type, message) => HealthCheckInUse(message: message),
  'HealthCheckVersionMismatch': (type, message) =>
      HealthCheckVersionMismatch(message: message),
  'HostedZoneAlreadyExists': (type, message) =>
      HostedZoneAlreadyExists(message: message),
  'HostedZoneNotEmpty': (type, message) => HostedZoneNotEmpty(message: message),
  'HostedZoneNotFound': (type, message) => HostedZoneNotFound(message: message),
  'HostedZoneNotPrivate': (type, message) =>
      HostedZoneNotPrivate(message: message),
  'HostedZonePartiallyDelegated': (type, message) =>
      HostedZonePartiallyDelegated(message: message),
  'IncompatibleVersion': (type, message) =>
      IncompatibleVersion(message: message),
  'InsufficientCloudWatchLogsResourcePolicy': (type, message) =>
      InsufficientCloudWatchLogsResourcePolicy(message: message),
  'InvalidArgument': (type, message) => InvalidArgument(message: message),
  'InvalidChangeBatch': (type, message) => InvalidChangeBatch(message: message),
  'InvalidDomainName': (type, message) => InvalidDomainName(message: message),
  'InvalidInput': (type, message) => InvalidInput(message: message),
  'InvalidKMSArn': (type, message) => InvalidKMSArn(message: message),
  'InvalidKeySigningKeyName': (type, message) =>
      InvalidKeySigningKeyName(message: message),
  'InvalidKeySigningKeyStatus': (type, message) =>
      InvalidKeySigningKeyStatus(message: message),
  'InvalidPaginationToken': (type, message) =>
      InvalidPaginationToken(message: message),
  'InvalidSigningStatus': (type, message) =>
      InvalidSigningStatus(message: message),
  'InvalidTrafficPolicyDocument': (type, message) =>
      InvalidTrafficPolicyDocument(message: message),
  'InvalidVPCId': (type, message) => InvalidVPCId(message: message),
  'KeySigningKeyAlreadyExists': (type, message) =>
      KeySigningKeyAlreadyExists(message: message),
  'KeySigningKeyInParentDSRecord': (type, message) =>
      KeySigningKeyInParentDSRecord(message: message),
  'KeySigningKeyInUse': (type, message) => KeySigningKeyInUse(message: message),
  'KeySigningKeyWithActiveStatusNotFound': (type, message) =>
      KeySigningKeyWithActiveStatusNotFound(message: message),
  'LastVPCAssociation': (type, message) => LastVPCAssociation(message: message),
  'LimitsExceeded': (type, message) => LimitsExceeded(message: message),
  'NoSuchChange': (type, message) => NoSuchChange(message: message),
  'NoSuchCidrCollectionException': (type, message) =>
      NoSuchCidrCollectionException(message: message),
  'NoSuchCidrLocationException': (type, message) =>
      NoSuchCidrLocationException(message: message),
  'NoSuchCloudWatchLogsLogGroup': (type, message) =>
      NoSuchCloudWatchLogsLogGroup(message: message),
  'NoSuchDelegationSet': (type, message) =>
      NoSuchDelegationSet(message: message),
  'NoSuchGeoLocation': (type, message) => NoSuchGeoLocation(message: message),
  'NoSuchHealthCheck': (type, message) => NoSuchHealthCheck(message: message),
  'NoSuchHostedZone': (type, message) => NoSuchHostedZone(message: message),
  'NoSuchKeySigningKey': (type, message) =>
      NoSuchKeySigningKey(message: message),
  'NoSuchQueryLoggingConfig': (type, message) =>
      NoSuchQueryLoggingConfig(message: message),
  'NoSuchTrafficPolicy': (type, message) =>
      NoSuchTrafficPolicy(message: message),
  'NoSuchTrafficPolicyInstance': (type, message) =>
      NoSuchTrafficPolicyInstance(message: message),
  'NotAuthorizedException': (type, message) =>
      NotAuthorizedException(message: message),
  'PriorRequestNotComplete': (type, message) =>
      PriorRequestNotComplete(message: message),
  'PublicZoneVPCAssociation': (type, message) =>
      PublicZoneVPCAssociation(message: message),
  'QueryLoggingConfigAlreadyExists': (type, message) =>
      QueryLoggingConfigAlreadyExists(message: message),
  'ThrottlingException': (type, message) =>
      ThrottlingException(message: message),
  'TooManyHealthChecks': (type, message) =>
      TooManyHealthChecks(message: message),
  'TooManyHostedZones': (type, message) => TooManyHostedZones(message: message),
  'TooManyKeySigningKeys': (type, message) =>
      TooManyKeySigningKeys(message: message),
  'TooManyTrafficPolicies': (type, message) =>
      TooManyTrafficPolicies(message: message),
  'TooManyTrafficPolicyInstances': (type, message) =>
      TooManyTrafficPolicyInstances(message: message),
  'TooManyTrafficPolicyVersionsForCurrentPolicy': (type, message) =>
      TooManyTrafficPolicyVersionsForCurrentPolicy(message: message),
  'TooManyVPCAssociationAuthorizations': (type, message) =>
      TooManyVPCAssociationAuthorizations(message: message),
  'TrafficPolicyAlreadyExists': (type, message) =>
      TrafficPolicyAlreadyExists(message: message),
  'TrafficPolicyInUse': (type, message) => TrafficPolicyInUse(message: message),
  'TrafficPolicyInstanceAlreadyExists': (type, message) =>
      TrafficPolicyInstanceAlreadyExists(message: message),
  'VPCAssociationAuthorizationNotFound': (type, message) =>
      VPCAssociationAuthorizationNotFound(message: message),
  'VPCAssociationNotFound': (type, message) =>
      VPCAssociationNotFound(message: message),
};
