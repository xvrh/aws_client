...
class BulkEmailDestinationStatus {
  ...
  factory BulkEmailDestinationStatus.fromXml(_s.XmlElement elem) {
    return BulkEmailDestinationStatus(
      ...
      status:
          BulkEmailStatus.fromString(_s.extractXmlStringValue(elem, 'Status')),
    );
  }
  ...
  factory CloudWatchDimensionConfiguration.fromXml(_s.XmlElement elem) {
    return CloudWatchDimensionConfiguration(
      ...
      dimensionValueSource: DimensionValueSource.fromString(
          _s.extractXmlStringValue(elem, 'DimensionValueSource')!),
    );
  }
...
class DeliveryOptions {
  ...
  factory DeliveryOptions.fromXml(_s.XmlElement elem) {
    return DeliveryOptions(
      tlsPolicy:
          TlsPolicy.fromString(_s.extractXmlStringValue(elem, 'TlsPolicy')),
    );
  }
...
class IdentityDkimAttributes {
  ...
  factory IdentityDkimAttributes.fromXml(_s.XmlElement elem) {
    return IdentityDkimAttributes(
      ...
      dkimVerificationStatus: VerificationStatus.fromString(
          _s.extractXmlStringValue(elem, 'DkimVerificationStatus')!),
      dkimTokens: _s
  ...
  factory IdentityMailFromDomainAttributes.fromXml(_s.XmlElement elem) {
    return IdentityMailFromDomainAttributes(
      behaviorOnMXFailure: BehaviorOnMXFailure.fromString(
          _s.extractXmlStringValue(elem, 'BehaviorOnMXFailure')!),
      mailFromDomain: _s.extractXmlStringValue(elem, 'MailFromDomain')!,
      mailFromDomainStatus: CustomMailFromStatus.fromString(
          _s.extractXmlStringValue(elem, 'MailFromDomainStatus')!),
    );
  }
  ...
  factory IdentityVerificationAttributes.fromXml(_s.XmlElement elem) {
    return IdentityVerificationAttributes(
      verificationStatus: VerificationStatus.fromString(
          _s.extractXmlStringValue(elem, 'VerificationStatus')!),
...
class LambdaAction {
  ...
  factory LambdaAction.fromXml(_s.XmlElement elem) {
    return LambdaAction(
      ...
      invocationType: InvocationType.fromString(
          _s.extractXmlStringValue(elem, 'InvocationType')),
      topicArn: _s.extractXmlStringValue(elem, 'TopicArn'),
    );
  }
...
class ReceiptIpFilter {
  ...
  factory ReceiptIpFilter.fromXml(_s.XmlElement elem) {
    return ReceiptIpFilter(
      ...
      policy: ReceiptFilterPolicy.fromString(
          _s.extractXmlStringValue(elem, 'Policy')!),
    );
  }
...
class SNSAction {
  ...
  factory SNSAction.fromXml(_s.XmlElement elem) {
    return SNSAction(
      topicArn: _s.extractXmlStringValue(elem, 'TopicArn')!,
      encoding: SNSActionEncoding.fromString(
          _s.extractXmlStringValue(elem, 'Encoding')),
    );
  }
...
class StopAction {
  ...
  factory StopAction.fromXml(_s.XmlElement elem) {
    return StopAction(
      scope: StopScope.fromString(_s.extractXmlStringValue(elem, 'Scope')!),
      topicArn: _s.extractXmlStringValue(elem, 'TopicArn'),
    );
  }
