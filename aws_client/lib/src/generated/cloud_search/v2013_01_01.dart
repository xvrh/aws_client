...
class AnalysisOptions {
  ...
  factory AnalysisOptions.fromXml(_s.XmlElement elem) {
    return AnalysisOptions(
      algorithmicStemming: AlgorithmicStemming.fromString(
          _s.extractXmlStringValue(elem, 'AlgorithmicStemming')),
...
class AnalysisScheme {
  ...
  factory AnalysisScheme.fromXml(_s.XmlElement elem) {
    return AnalysisScheme(
      analysisSchemeLanguage: AnalysisSchemeLanguage.fromString(
          _s.extractXmlStringValue(elem, 'AnalysisSchemeLanguage')!),
...
class DocumentSuggesterOptions {
  ...
  factory DocumentSuggesterOptions.fromXml(_s.XmlElement elem) {
    return DocumentSuggesterOptions(
      sourceField: _s.extractXmlStringValue(elem, 'SourceField')!,
      fuzzyMatching: SuggesterFuzzyMatching.fromString(
          _s.extractXmlStringValue(elem, 'FuzzyMatching')),
...
class DomainEndpointOptions {
  ...
  factory DomainEndpointOptions.fromXml(_s.XmlElement elem) {
    return DomainEndpointOptions(
      ...
      tLSSecurityPolicy: TLSSecurityPolicy.fromString(
          _s.extractXmlStringValue(elem, 'TLSSecurityPolicy')),
    );
  }
...
class IndexField {
  ...
  factory IndexField.fromXml(_s.XmlElement elem) {
    return IndexField(
      ...
      indexFieldType: IndexFieldType.fromString(
          _s.extractXmlStringValue(elem, 'IndexFieldType')!),
      dateArrayOptions: _s
...
class OptionStatus {
  ...
  factory OptionStatus.fromXml(_s.XmlElement elem) {
    return OptionStatus(
      ...
      state: OptionState.fromString(_s.extractXmlStringValue(elem, 'State')!),
...
class ScalingParameters {
  ...
  factory ScalingParameters.fromXml(_s.XmlElement elem) {
    return ScalingParameters(
      desiredInstanceType: PartitionInstanceType.fromString(
          _s.extractXmlStringValue(elem, 'DesiredInstanceType')),
