...
class LexModelsV2 {
  ...
  Future<BuildBotLocaleResponse> buildBotLocale({
    ...
    ArgumentError.checkNotNull(localeId, 'localeId');
  ...
  Future<CreateBotResponse> createBot({
    ...
    ArgumentError.checkNotNull(dataPrivacy, 'dataPrivacy');
  ...
  Future<CreateBotAliasResponse> createBotAlias({
    ...
    ArgumentError.checkNotNull(botAliasName, 'botAliasName');
    ArgumentError.checkNotNull(botId, 'botId');
    final $payload = <String, dynamic>{
  ...
  Future<CreateExportResponse> createExport({
    ...
    ArgumentError.checkNotNull(fileFormat, 'fileFormat');
    ArgumentError.checkNotNull(resourceSpecification, 'resourceSpecification');
    final $payload = <String, dynamic>{
  ...
  Future<CreateIntentResponse> createIntent({
    ...
    ArgumentError.checkNotNull(botId, 'botId');
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(intentName, 'intentName');
    ArgumentError.checkNotNull(localeId, 'localeId');
    final $payload = <String, dynamic>{
  ...
  Future<CreateSlotResponse> createSlot({
    ...
    ArgumentError.checkNotNull(botId, 'botId');
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(intentId, 'intentId');
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(slotName, 'slotName');
    ArgumentError.checkNotNull(
  ...
  Future<CreateSlotTypeResponse> createSlotType({
    ...
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(slotTypeName, 'slotTypeName');
    final $payload = <String, dynamic>{
  ...
  Future<DeleteBotAliasResponse> deleteBotAlias({
    ...
    ArgumentError.checkNotNull(botAliasId, 'botAliasId');
    ArgumentError.checkNotNull(botId, 'botId');
    final $query = <String, List<String>>{
      if (skipResourceInUseCheck != null)
        'skipResourceInUseCheck': [skipResourceInUseCheck.toString()],
  ...
  /// <code>ResourceInUseException</code> exception if you try to delete a bot
  /// version that has an alias pointing at it. Set the
  /// <code>skipResourceInUseCheck</code> parameter to <code>true</code> to skip
  /// this check and remove the version even if an alias points to it.
  ...
  Future<void> deleteSlot({
    ...
    ArgumentError.checkNotNull(intentId, 'intentId');
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(slotId, 'slotId');
    await _protocol.send(
      payload: null,
      method: 'DELETE',
      requestUri:
  ...
  Future<void> deleteSlotType({
    ...
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(slotTypeId, 'slotTypeId');
    final $query = <String, List<String>>{
      if (skipResourceInUseCheck != null)
        'skipResourceInUseCheck': [skipResourceInUseCheck.toString()],
    };
  ...
  Future<DescribeBotRecommendationResponse> describeBotRecommendation({
    ...
    ArgumentError.checkNotNull(botId, 'botId');
    ArgumentError.checkNotNull(botRecommendationId, 'botRecommendationId');
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(localeId, 'localeId');
    final response = await _protocol.send(
      payload: null,
  ...
  Future<ListAggregatedUtterancesResponse> listAggregatedUtterances({
    ...
    ArgumentError.checkNotNull(aggregationDuration, 'aggregationDuration');
    ArgumentError.checkNotNull(botId, 'botId');
    ArgumentError.checkNotNull(localeId, 'localeId');
    _s.validateNumRange(
      'maxResults',
  ...
  /// information, see <a
  /// href="https://docs.aws.amazon.com/lexv2/latest/dg/API_CreateIntent.html">CreateIntent</a>.
  ///
  /// May throw [ThrottlingException].
  /// May throw [ServiceQuotaExceededException].
  /// May throw [ValidationException].
  ...
  Future<UpdateBotRecommendationResponse> updateBotRecommendation({
    ...
    ArgumentError.checkNotNull(botRecommendationId, 'botRecommendationId');
    ArgumentError.checkNotNull(botVersion, 'botVersion');
    ArgumentError.checkNotNull(encryptionSetting, 'encryptionSetting');
    ArgumentError.checkNotNull(localeId, 'localeId');
    final $payload = <String, dynamic>{
      'encryptionSetting': encryptionSetting,
    };
...
class IntentClosingSetting {
  ...
  factory IntentClosingSetting.fromJson(Map<String, dynamic> json) {
    return IntentClosingSetting(
      closingResponse: ResponseSpecification.fromJson(
...
class IntentConfirmationSetting {
  ...
  IntentConfirmationSetting({
    required this.declinationResponse,
  ...
  factory IntentConfirmationSetting.fromJson(Map<String, dynamic> json) {
    return IntentConfirmationSetting(
      declinationResponse: ResponseSpecification.fromJson(
