...
class LexRuntimeV2 {
  ...
  Future<PutSessionResponse> putSession({
    ...
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(sessionId, 'sessionId');
    ArgumentError.checkNotNull(sessionState, 'sessionState');
  ...
  Future<RecognizeUtteranceResponse> recognizeUtterance({
    ...
    ArgumentError.checkNotNull(botId, 'botId');
    ArgumentError.checkNotNull(localeId, 'localeId');
    ArgumentError.checkNotNull(requestContentType, 'requestContentType');
    ArgumentError.checkNotNull(sessionId, 'sessionId');
    final headers = <String, String>{
...
class RuntimeHintDetails {
  ...
  RuntimeHintDetails({
    required this.runtimeHintValues,
  });
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      'runtimeHintValues': runtimeHintValues,
    };
  }
}
...
///
/// For more information, see <a
/// href="https://docs.aws.amazon.com/lexv2/latest/dg/using-hints.xml">Using
